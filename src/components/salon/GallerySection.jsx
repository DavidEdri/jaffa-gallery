...
const images = [
  ...
  { src: `${base}assets/gallery-07.jpg`, alt: "Candlelit dining with candelabras", cols: "col-span-1" },
  ...
  { src: `${base}assets/gallery-11.jpg`, alt: "Grand salon with artwork and rugs", cols: "col-span-2" },
];
...
export default function GallerySection() {
  ...
  return (
    <section className="py-12 md:py-20 px-0 md:px-10">
      ...
      {/* Desktop: grid */}
      <div className="hidden md:grid grid-cols-3 grid-flow-dense gap-2 max-w-5xl mx-auto">
        {images.map((img, i) => (
          <div
            key={i}
